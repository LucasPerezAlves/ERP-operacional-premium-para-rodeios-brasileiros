...
public class PerfilFuncionarioService {
    ...
    public PerfilFuncionarioResponse atualizar(UUID id, PerfilFuncionarioRequest request) {
        ...
        perfil.setLimiteAtencao(request.limiteAtencao().setScale(2, RoundingMode.HALF_EVEN));
        perfil.setLimiteCritico(request.limiteCritico().setScale(2, RoundingMode.HALF_EVEN));
